(() => {
  ...
  if (confusionSchedule) {
    ...
    confusionSchedule.option_d = '沒有固定順序'; confusionSchedule.answer = 'A';
  ...
  if (hvCapacity) {
    hvCapacity.topic = '第9單元｜備用容量參與門檻與基本單位';
    hvCapacity.question = '某賣方想以25kW資源參與備用容量市場。依114.10第5版交易容量規則，何者正確？';
