...
const checks = [
  ...
  ['V3變更當月參與費仍原額、次月起新額', /本月仍按原額、次月起按新額/.test(v3) && /oldF\+\(months-1\)\*newF/.test(v3)],
  ...
  ['V6明確規定落在操作曲線允許範圍內SBSPM=100%', /範圍內.*SBSPM＝100%|SBSPM=100%/.test(v6)],
  ...
  ['V7備用容量媒合時程使用工作日', /第1～3個工作日/.test(v7) && /第4～5個工作日/.test(v7) && /第6～10個工作日/.test(v7)],
  ['V7涵蓋V2六題與V3五題媒合時程修正', /V2U9-004/.test(v7) && /V2U9-024/.test(v7) && /V3U9-011/.test(v7) && /V3U9-015/.test(v7) && /115工作日修正/.test(v7)],
